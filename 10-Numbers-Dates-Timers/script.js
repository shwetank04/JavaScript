...
/////////////////////////////////////////////////
// Functions
const foramtMovementDate = function (date) {
...
const startlogoutTimer = function () {
  ...
  const timer = setInterval(function () {
    ...
    //Decrease by 1s
    //when time is 0 then log user out
    if (time === 0) {
      clearInterval(timer);
...
console.log(Math.max(5, 34, 56, 11));
console.log(Math.min(5, 34, 56, 11));
